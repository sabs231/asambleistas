...
define([ "jquery","backbone", "../models/SampleModel", "../collections/SampleCollection", "../views/SampleView" ], function($, Backbone, CategoryModel, CategoriesCollection, CategoryView) {
